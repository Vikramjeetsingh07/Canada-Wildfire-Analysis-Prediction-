...
# this is pipeline, that we used for final Pipeline including true and false labels in a column named in_modis
...
output_path = "top_ten_wildfire_weather_data_complete.csv"
